...
const EditPrivateLeague = () => {
	...
	const isEditingPrivateLeague = useAppSelector(selectIsEditingPrivateLeague);
		...
		<DashboardLayout
			title={
				isFetchingSpecificPrivateLeague
					? "Edit Private League"
					: `Edit Private League - ${leagueDetails?.name}`
			}
		>
			{isFetchingSpecificPrivateLeague ? (
				<PageLoading />
						...
						>
								...
								<div className="grid md:grid-cols-2 gap-4">
									...
									<p className="text-[#222222] text-sm">Week</p>
										...
										<Controller
											...
											defaultValue={() =>
												weeks.find(
													(week) => week.id === leagueDetails?.scoringStarts
												)
											}
											render={({ field: { onChange, value, ref } }) => (
												<Select
							...
							<div className="mt-5">
								...
								<Input
									...
									min={0}
									defaultValue={leagueDetails?.entranceFee}
								...
								<>
									...
									<div className="mt-5">
										...
										<Input
											...
											type="number"
											min={0}
											defaultValue={leagueDetails?.numberOfPlayers}
							...
							<Button
								...
								loading={isEditingPrivateLeague}
							/>
						</form>
					</main>
				</>
...
export default EditPrivateLeague;
