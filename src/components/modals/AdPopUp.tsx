        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel
                // as={Container}
                // className="bg-red-600 w-full max-w-[80vw] transform overflow-hidden rounded-lg  p-6 md:px-16 md:py-24 text-left align-middle shadow-xl transition-all relative"
  ...
  <div className="flex items-center justify-between mt-8">
    <div className="md:w-3/5">
      <h2 className="text-3xl lg:text-6xl text-white font-bold">
        We’re the fastest growing <span className="text-[#d52a2a]">FREE</span>{" "}
        sports prediction community!
      </h2>
    </div> */
}
{
